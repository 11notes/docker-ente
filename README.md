...
>* ... this image is auto updated to the latest version via CI/CD (semver based on commit date of /server path, check [workflow](https://github.com/11notes/docker-ente/blob/master/.github/workflows/update.yml) for more info)
